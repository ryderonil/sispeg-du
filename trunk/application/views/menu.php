<div class="vernav2 iconmenu" style="top: 115px;">
    	...
    	<ul>					
        	...
        	<li <?php if($menu_terpilih == 'pegawai') { echo 'class="current"'; } ?>><a href="#agenda" class="arrow">Pegawai</a>
            	...
            	<ul id="agenda">
               		<li <?php if($sub_menu_terpilih == 'daftar_pegawai') { echo 'class="current"'; } ?>><a href="<?php echo base_url() ?>index.php/agenda">Daftar Pegawai</a></li>
                    <?php 		
						if($role_jabatan == '2' || $role_jabatan == '4'){
					?>
					<li <?php if($sub_menu_terpilih == 'tambah_pegawai') { echo 'class="current"'; } ?>><a href="<?php echo base_url() ?>index.php/agenda/viewTambahAgenda">Tambah Pegawai</a></li>
                    <?php
						}
					?>
			...
			<li <?php if($menu_terpilih == 'laporan') { echo 'class="current"'; } ?>><a href="#idlaporan" class="arrow">Laporan</a>
            	...
            	<ul id="idlaporan">
                    ...
                    <li <?php if($sub_menu_terpilih == 'laporan_pegawai') { echo 'class="current"'; } ?>><a href="<?php echo base_url(); ?>index.php/pengelolaan_inventaris/add_process">Laporan Chart</a></li>
                </ul>
            </li>
        </ul>
