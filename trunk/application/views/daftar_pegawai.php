...
<tbody>
  ...
  <td align="center">
	<a href="<?php echo base_url().'index.php/pengelolaan_inventaris/detail_barang/'.$row->ID; ?>" title='Detail' class="btn btn4 btn_yellow btn_search radius50" alt="Detail"></a>
	<a href="<?php echo base_url().'index.php/pengelolaan_inventaris/edit_proses/'.$row->ID; ?>" title='Edit' class="btn btn4 btn_yellow btn_flag" alt="Edit"></a>
	</td>
	</tr>
	 <?php
					  } 
